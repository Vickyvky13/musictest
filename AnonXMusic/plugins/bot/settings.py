...
@app.on_callback_query(filters.regex("both") & ~BANNED_USERS)
async def both_cb(client, query: CallbackQuery):
    th=random.choice(bo)
    await query.edit_message_media(InputMediaPhoto(th, caption=f"» {query.from_user.mention} ᴄʜᴏᴏsᴇ ᴛʜᴇ ᴄᴀᴛᴇɢᴏʀʏ ғᴏʀ ᴡʜɪᴄʜ ʏᴏᴜ ᴡᴀɴɴᴀ ɢᴇᴛ ʜᴇʟᴘ!\n» ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ /:"), reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="ᴍᴀɴᴀɢᴇᴍᴇɴᴛ", callback_data="help_back"), 
...
async def hellpp(client, query: CallbackQuery):
    await query.answer(text=f"{query.from_user.first_name} Wait A Moment, Opening Management Menu. It May Take Sometime.", show_alert=True)
...
oki = ["https://te.legra.ph/file/9a4449cf6728e6751935b.jpg", "https://te.legra.ph/file/bc422fef7758dffe71b5e.jpg", "https://te.legra.ph/file/72284e9f6878383565287.jpg"]

@app.on_callback_query(filters.regex("spot") & ~BANNED_USERS)
async def spoot(client, query: CallbackQuery):
    e=random.choice(oki)
    await query.edit_message_media(InputMediaPhoto(e, caption=f"»{query.from_user.mention} ᴄʜᴏᴏsᴇ ᴛʜᴇ ᴄᴀᴛᴇɢᴏʀʏ ғᴏʀ ᴡʜɪᴄʜ ʏᴏᴜ ᴡᴀɴɴᴀ ɢᴇᴛ ʜᴇʟᴘ!"), reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/solotree_support"), 
...
async def settings_back_markup(client, CallbackQuery: CallbackQuery, _):
    ...
    if CallbackQuery.message.chat.type == ChatType.PRIVATE:
        ...
        ho=random.choice(st)
        return await CallbackQuery.edit_message_media(InputMediaPhoto(ho,
