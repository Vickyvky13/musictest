        ...
        for search in result:
            ...
            if await is_active_chat(chat_id):
                ...
                if len(check) > config.QUEUE_LIMIT:
                    return await app.send_message(chat_id, f"<b><u>ᴄʜᴇᴄᴋ ᴏᴜᴛ ᴛʜᴇ ǫᴜᴇᴜᴇ ʟɪꜱᴛ</u></b> : /queue\n\nʟᴏᴏᴋꜱ ʟɪᴋᴇ ʏᴏᴜ ᴀʀᴇ ꜱᴘᴀᴍᴍɪɴɢ ᴀʟʀᴇᴀᴅʏ 20 ꜱᴏɴɢꜱ ɪɴ Qᴜᴇᴜᴇ ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ ᴛᴏ ꜰɪɴɪꜱʜ ᴛʜᴇᴍ ꜰɪʀꜱᴛ ᴇʟꜱᴇ ᴜꜱᴇ /end.")
                await put_queue(
                    chat_id,
                    original_chat_id,
                    f"vid_{vidid}",
